            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub  {{ request()->routeIs('add_debiteur', 'edit_debiteur') ? 'active' : '' }}">
                            <a href="#" class='sidebar-link '>
                                <i class="bi bi-buildings-fill"></i>
                                <span>Débiteurs</span>
                            </a>
                            <ul class="submenu  {{ request()->routeIs('add_debiteur', 'edit_debiteur') ? 'active' : '' }}">
                                <li class="submenu-item  {{ request()->routeIs('add_debiteur') ? 'active' : '' }}">
                                    <a href="/add_debiteur">Ajouter</a>
                                </li>
                                <li class="submenu-item  {{ request()->routeIs('edit_debiteur') ? 'active' : '' }}">
                                    <a href="/edit_debiteur">Modifier</a>
                                </li>
                        ...
                        <li class="sidebar-item  has-sub  {{ request()->routeIs('pays', 'region', 'cercle') ? 'active' : '' }}">
                            <a href="#" class='sidebar-link '>
                                <i class="bi bi-geo-fill"></i>
                                <span>Pays</span>
                            </a>
                            <ul class="submenu  {{ request()->routeIs('pays', 'region', 'village', 'cercle') ? 'active' : '' }}">
                                <li class="submenu-item  {{ request()->routeIs('village') ? 'active' : '' }}">
                                    <a href="/village">Village</a>
                                </li>
                                <li class="submenu-item  {{ request()->routeIs('region') ? 'active' : '' }}">
                                    <a href="/region">Region</a>
                                </li>
                                <li class="submenu-item  {{ request()->routeIs('cercle') ? 'active' : '' }}">
                                    <a href="/cercle">Cercle</a>
                                </li>
                                <li class="submenu-item  {{ request()->routeIs('pays') ? 'active' : '' }}">
                                    <a href="/pays">Pays</a>
                                </li>
